...
select "Name" as "Nombre", "Milliseconds" as "Duración"
from "Track" t 
...
select "FirstName" as "Nombre" , "SupportRepId" as "ID_soporte"
from "Customer" c 
...
select "InvoiceId" as "ID", "Total" 
from "Invoice" i 
where "Total" > 10 and "InvoiceId" < 50;
...
select "Name" as "Nombre", "MediaTypeId" as "Tipo de medio"
from "Track" t 
